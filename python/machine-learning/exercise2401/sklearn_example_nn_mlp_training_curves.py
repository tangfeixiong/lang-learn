...
<https://scikit-learn.org/stable/auto_examples/neural_networks/plot_mlp_training_curves.html#compare-stochastic-learning-strategies-for-mlpclassifier>
"""
...
def plot_on_dataset(X, y, ax, name) -> None:
    ...
    mlps = []
    if name == "digits":
        # digits is large but converges fairly quickly
        max_iter = 15
    else:
        max_iter = 400
